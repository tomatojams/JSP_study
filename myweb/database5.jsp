...
<html>
<head><title> 데이타베이스 삽입 테스트 </title></head>
...
//데이타 가져올 SQL문을 실행
stmt.executeUpdate("INSERT INTO student (st_name, st_sex, st_addr, st_major, st_contact) VALUES ('나홍석','남','서울','컴퓨터','010-4567-8901')");
